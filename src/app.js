...
mongoose.connect("mongodb+srv://juancarese:t87DpPvHZGg_d6d@coder.xbe17pi.mongodb.net/ecomerce");

app.use(session({
    secret: "C0d3rh0us3",
    store: MongoStore.create({
     mongoUrl: "mongodb+srv://juancarese:t87DpPvHZGg_d6d@coder.xbe17pi.mongodb.net/ecomerce"
    }),
    resave: true,
